...
export function PlayerBar({ client }: PlayerBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-zinc-900 border-t border-zinc-800 px-3 py-2 shadow-[0_-1px_rgba(255,255,255,0.05)_inset]">
